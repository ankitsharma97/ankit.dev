...
const CONFIG = {
    ...
    portfolioProjects: [
        ...
        },
        {
            ...
            results: [
                { title: "Comprehensive educational management system using Django" },
                { title: "Role-based access control with JWT authentication" },
                { title: "Analytics dashboard and automated workflows" },
                { title: "70% reduction in administrative workload" },
            ],
    ...
    testimonials: [
        ...
        },
        {
            ...
            text: "During this internship, I developed responsive web applications, collaborated on UI/UX design, and implemented backend services. Successfully contributed to projects that enhanced user engagement and system efficiency.",
            avatar: shanzilAvatar,
        },
        {
            name: "AKTU, Lucknow",
            position: "Information Technology Student",
            text: "Currently pursuing Bachelor of Technology in Information Technology (2026). I have a good knowledge of programming languages, but I am still learning new things daily. I always wanted to be a part of team that is working to make positive changes in society.",
    ...
    experienceData: [
        ...
        },
        {
            ...
            description: "During this internship, I developed responsive web applications, collaborated on UI/UX design, and implemented backend services. Successfully contributed to projects that enhanced user engagement and system efficiency.",
            achievements: [
